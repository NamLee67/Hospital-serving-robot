...
QT_MOC_LITERAL(6, 72, 21), // "onTextForOtherClients"
QT_MOC_LITERAL(7, 94, 7), // "message"
QT_MOC_LITERAL(8, 102, 8), // "receiver"
QT_MOC_LITERAL(9, 111, 6), // "sender"
QT_MOC_LITERAL(10, 118, 27), // "newClientConnectionReceived"
QT_MOC_LITERAL(11, 146, 20) // "onClientDisconnected"

    },
    "ServerManager\0newClientConnected\0\0"
    "QTcpSocket*\0client\0clientDisconnected\0"
    "onTextForOtherClients\0message\0receiver\0"
...
void ServerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onTextForOtherClients((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
