...
#include "map_msgs/srv/detail/save_map__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/string__functions.h"  // filename
...
using _SaveMap_Request__ros_msg_type = map_msgs__srv__SaveMap_Request;
...
static uint32_t _SaveMap_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_map_msgs__srv__SaveMap_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_msgs__srv__SaveMap_Request;
    is_plain =
      (
...
static size_t _SaveMap_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_map_msgs__srv__SaveMap_Request(
...
using _SaveMap_Response__ros_msg_type = map_msgs__srv__SaveMap_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_map_msgs__srv__SaveMap_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = map_msgs__srv__SaveMap_Response;
    is_plain =
      (
...
static size_t _SaveMap_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_map_msgs__srv__SaveMap_Response(
    full_bounded, is_plain, 0);
