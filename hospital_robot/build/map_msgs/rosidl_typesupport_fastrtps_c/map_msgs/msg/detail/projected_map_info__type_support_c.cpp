...
#include "map_msgs/msg/detail/projected_map_info__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_msgs__msg__ProjectedMapInfo;
    is_plain =
      (
...
static size_t _ProjectedMapInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_map_msgs__msg__ProjectedMapInfo(
