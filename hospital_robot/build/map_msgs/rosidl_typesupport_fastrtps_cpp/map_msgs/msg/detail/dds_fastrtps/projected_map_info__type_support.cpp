...
#include "map_msgs/msg/detail/projected_map_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_msgs::msg::ProjectedMapInfo;
    is_plain =
      (
...
static size_t _ProjectedMapInfo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ProjectedMapInfo(full_bounded, is_plain, 0);
