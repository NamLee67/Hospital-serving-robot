...
#include "map_msgs/srv/detail/set_map_projections__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_msgs::srv::SetMapProjections_Request;
    is_plain =
      (
...
static size_t _SetMapProjections_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetMapProjections_Request(full_bounded, is_plain, 0);
...
{
  return &map_msgs::srv::typesupport_fastrtps_cpp::_SetMapProjections_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = map_msgs::srv::SetMapProjections_Response;
    is_plain =
      (
...
static size_t _SetMapProjections_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetMapProjections_Response(full_bounded, is_plain, 0);
...
{
  return &map_msgs::srv::typesupport_fastrtps_cpp::_SetMapProjections_Response__handle;
}
...
{
  return &map_msgs::srv::typesupport_fastrtps_cpp::_SetMapProjections__handle;
}
