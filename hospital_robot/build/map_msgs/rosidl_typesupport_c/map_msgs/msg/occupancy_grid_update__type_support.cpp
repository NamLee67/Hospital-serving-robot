...
static const _OccupancyGridUpdate_type_support_symbol_names_t _OccupancyGridUpdate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, map_msgs, msg, OccupancyGridUpdate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, map_msgs, msg, OccupancyGridUpdate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, map_msgs, msg, OccupancyGridUpdate)() {
  return &::map_msgs::msg::rosidl_typesupport_c::OccupancyGridUpdate_message_type_support_handle;
}
